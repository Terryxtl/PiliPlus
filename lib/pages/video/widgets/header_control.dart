          ...
          child: ListView(
            ...
            children: [
              ...
              if (!isFileSource) ...[
                ...
                if (videoDetailCtr.canEditMultiPageSkip)
                  ListTile(
                    dense: true,
                    onTap: () async {
                      Get.back();
                      await videoDetailCtr.showMultiPageSkipDialog(
                        this.context,
                      );
                      if (mounted) {
                        this.setState(() {});
                    ...
                    leading: const Icon(Icons.skip_next_outlined, size: 20),
                    title: const Text('多P片头片尾', style: titleStyle),
                    subtitle: Text(
                      videoDetailCtr.multiPageSkipSummary,
                      style: subTitleStyle,
                    ),
                  ),
              ],
